...
try:
    ...
    print(f"❌ 嚴重錯誤：Render 後台的 Environment Variables 忘記設定項目：{e}")
    raise KeyError(f"請至 Render 後台設定環境變數 {e}")
